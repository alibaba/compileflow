...
vocabulary remains in the [project glossary](../glossary.md). Java type names, enum values, configuration keys, and
wire fields keep their source spelling when they appear in prose.

A process definition or its XML language is a **process model**, not a “process protocol.” The word _protocol_ is
reserved for wire, database, and synchronization contracts.

| Term                  | Meaning                                                                                                                                                                                                                                    |
| --------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Process definition    | Self-describing model source supplied by the caller. `ProcessDefinition.Inline` contains model type, process code, and exact text; it does not carry a version, alias, or deployment metadata.                                             |
