...
<!-- What problem does this change solve, and why does it matter? -->

## Design

<!-- Describe the chosen behavior, important alternatives, and affected invariants. -->

## Validation

<!-- List the exact commands run and the relevant results. -->
...
- [ ] The change is focused and includes tests at the appropriate boundary.
- [ ] Relevant English and Chinese documentation is current.
- [ ] Obsolete code, documentation, and generated artifacts are removed.
