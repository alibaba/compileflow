...
import com.alibaba.compileflow.engine.tbbpm.definition.BpmNode;
...
public class BpmParser extends AbstractTbbpmElementParser<BpmNode> {
    ...
    protected BpmNode doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        bpmNode.setId(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_ID));
        bpmNode.setCode(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_CODE));
        bpmNode.setName(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_NAME));
        bpmNode.setType(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_TYPE));
        bpmNode.setDescription(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_DESCRIPTION));
