 ...
 * @author yusu
 */
public abstract class ScriptActionHandleParser extends AbstractTbbpmElementParser<ScriptActionHandle> {
    ...
    protected ScriptActionHandle doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        String expression = xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_EXPRESSION);
        if (expression != null) {
