...
/**
 * XML parser for TBBPM continue nodes.
 *
 * @author yusu
 */
public class ContinueParser extends AbstractTbbpmElementParser<ContinueNode> {
    ...
    protected ContinueNode doParse(XmlSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        parseCommonNodeAttributes(xmlSource, continueNode);
        continueNode.setCondition(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_CONDITION));
        return continueNode;
    }
