...
import com.alibaba.compileflow.engine.tbbpm.definition.AutoTaskNode;
...
public class AutoTaskParser extends AbstractTbbpmElementParser<AutoTaskNode> {
    ...
    protected AutoTaskNode doParse(XMLSource xmlSource, ParseContext parseContext) {
        ...
        autoTaskNode.setId(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_ID));
        autoTaskNode.setName(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_NAME));
        autoTaskNode.setTag(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_TAG));
        autoTaskNode.setDescription(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_DESCRIPTION));
        autoTaskNode.setG(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_G));
        return autoTaskNode;
    }
