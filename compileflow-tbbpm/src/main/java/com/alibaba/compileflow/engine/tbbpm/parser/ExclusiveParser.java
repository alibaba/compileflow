...
/**
 * XML parser for TBBPM exclusive gateways.
 *
 * @author wuxiang
 * @author yusu
 */
public class ExclusiveParser extends AbstractTbbpmElementParser<ExclusiveNode> {
    @Override
    protected ExclusiveNode doParse(XmlSource xmlSource, ParseContext parseContext) throws Exception {
        ExclusiveNode node = new ExclusiveNode();
