...
/**
 * XML writer for TBBPM inclusive gateway nodes.
 *
 * @author yusu
 */
public class InclusiveWriter extends AbstractTbbpmNodeWriter<InclusiveNode> {
    @Override
    ...
    @Override
    public Class<InclusiveNode> getElementClass() {
        return InclusiveNode.class;
    }
}
