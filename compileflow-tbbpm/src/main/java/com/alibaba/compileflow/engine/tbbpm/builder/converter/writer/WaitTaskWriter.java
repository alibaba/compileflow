...
public class WaitTaskWriter extends AbstractTbbpmInOutActionNodeWriter<WaitTaskNode> {
    ...
    @Override
    protected void writeAction(WaitTaskNode element, XMLStreamWriter xsw) throws Exception {
        writeAction(TbbpmModelConstants.IN_ACTION, element.getInAction(), xsw);
        writeAction(TbbpmModelConstants.OUT_ACTION, element.getOutAction(), xsw);
    }
