...
public class SubBpmParser extends AbstractTbbpmElementParser<SubBpmNode> {
    ...
    protected SubBpmNode doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        subBpmNode.setId(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_ID));
        subBpmNode.setName(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_NAME));
        subBpmNode.setTag(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_TAG));
        subBpmNode.setDescription(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_DESCRIPTION));
        subBpmNode.setG(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_G));
        subBpmNode.setSubBpmCode(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_SUB_BPM_CODE));
        subBpmNode.setType(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_TYPE));
        subBpmNode.setWaitForCompletion(xmlSource.getBoolean(TbbpmModelConstants.ATTRIBUTE_WAIT_FOR_COMPLETION));
        subBpmNode.setWaitForTrigger(xmlSource.getBoolean(TbbpmModelConstants.ATTRIBUTE_WAIT_FOR_TRIGGER));
        return subBpmNode;
    }
