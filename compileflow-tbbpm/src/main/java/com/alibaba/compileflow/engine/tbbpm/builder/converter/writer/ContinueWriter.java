 ...
 * @author yusu
 */
public class ContinueWriter extends AbstractTbbpmNodeWriter<ContinueNode> {
    ...
    protected void enrichNodeAttr(ContinueNode node, XMLStreamWriter xsw) throws Exception {
        writeAttribute(xsw, TbbpmModelConstants.ATTRIBUTE_EXPRESSION, node.getExpression());
    }
