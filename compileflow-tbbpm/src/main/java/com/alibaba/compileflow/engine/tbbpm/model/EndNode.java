...
/**
 * Marks the termination point of a TBBPM process.
 *
 * <p>Each process must have at least one end node. When execution reaches
 * an end node, the process instance completes normally.
 *
 * @author wuxiang
 * @author yusu
 */
