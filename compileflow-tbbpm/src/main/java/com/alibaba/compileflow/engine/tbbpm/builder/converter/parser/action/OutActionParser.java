...
import com.alibaba.compileflow.engine.core.definition.action.impl.OutAction;
 ...
 * @author yusu
 */
public class OutActionParser extends ActionParser {

    @Override
    protected Action doParse(XMLSource xmlSource, ParseContext parseContext) {
        OutAction action = new OutAction();
        action.setType(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_TYPE));
        return action;
    }

    @Override
    public String getName() {
        return TbbpmModelConstants.OUT_ACTION;
    }
