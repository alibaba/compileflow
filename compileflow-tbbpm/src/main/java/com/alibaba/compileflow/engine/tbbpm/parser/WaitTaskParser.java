...
/**
 * XML parser for TBBPM wait task nodes.
 *
 * @author wuxiang
 * @author yusu
 */
public class WaitTaskParser extends AbstractTbbpmElementParser<WaitTaskNode> {
    ...
    protected WaitTaskNode doParse(XmlSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        parseCommonNodeAttributes(xmlSource, waitTaskNode);
        waitTaskNode.setTimeout(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_TIMEOUT));
        return waitTaskNode;
    }
