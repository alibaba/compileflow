...
import com.alibaba.compileflow.engine.core.definition.action.impl.ActionHandle;
 ...
 * @author yusu
 */
public abstract class AbstractActionHandleWriter<S extends ActionHandle> extends AbstractTbbpmFlowElementWriter<S> {

    @Override
    protected void doWrite(S element, XMLStreamWriter xsw) throws Exception {
        xsw.writeStartElement(TbbpmModelConstants.ACTION_HANDLE);
