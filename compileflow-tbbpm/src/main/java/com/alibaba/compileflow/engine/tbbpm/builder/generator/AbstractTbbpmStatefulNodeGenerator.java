...
import com.alibaba.compileflow.engine.tbbpm.definition.StatefulNode;

/**
 * @author yusu
 */
public abstract class AbstractTbbpmStatefulNodeGenerator<N extends StatefulNode>
        extends AbstractStatefulNodeCodeGenerator<N> {

    public AbstractTbbpmStatefulNodeGenerator(GeneratorContext context, N flowNode) {
