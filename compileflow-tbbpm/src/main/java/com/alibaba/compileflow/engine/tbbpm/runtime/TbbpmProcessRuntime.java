 ...
 */
package com.alibaba.compileflow.engine.tbbpm.runtime;
...
/**
 * TBBPM-specific process runtime implementation.
...
public class TbbpmProcessRuntime extends AbstractProcessRuntime<TbbpmModel> {
    ...
    public TbbpmProcessRuntime(TbbpmModel flowModel, Class<? extends ProcessInstance> processInstanceClass) {
