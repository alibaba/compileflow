 ...
 */
package com.alibaba.compileflow.engine.tbbpm.builder.converter.parser.var;
...
public class VarParser extends AbstractTbbpmElementParser<Var> {
    ...
    protected Var doParse(XMLSource xmlSource, ParseContext parseContext) {
        ...
        varNode.setContextVarName(xmlSource.getString(TbbpmModelConstants.ATTRIBUTE_CONTEXT_VAR_NAME));
        return varNode;
    }
