...
/**
 * XML writer for TBBPM parallel gateway nodes.
 *
 * @author yusu
 */
public class ParallelWriter extends AbstractTbbpmNodeWriter<ParallelNode> {
    @Override
    ...
    @Override
    public Class<ParallelNode> getElementClass() {
