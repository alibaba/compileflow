...
public class DurableSampleApplication {
    ...
    DurableVersionDefinitionSource durableVersionDefinitionSource() throws IOException {
        ...
        ProcessDefinition.Inline definition = ProcessDefinition.inline(PROCESS.code(), content);
        return requested -> requested.equals(PROCESS)
                ? Optional.of(new DurableVersionDefinitionSource.VersionDefinition(ProcessModelType.TBBPM, definition))
                : Optional.empty();
    }
