 ...
 * @author yusu
 */
public final class LocalReadyRoutingStateSnapshot {
    ...
    public LocalReadyRoutingStateSnapshot(int desiredAliasCount, int localReadyAliasCount, int pendingAliasCount,
