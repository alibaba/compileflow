 ...
 * @author yusu
 */
final class RuntimeOwnerIds {
    private RuntimeOwnerIds() {
    }

    static String alias(String namespace, String code, String alias) {
     ...
     *
     * @param sequence positive manager-local sequence
     * @return canonical owner identifier
     */
    static String installationLease(long sequence) {
        if (sequence <= 0L) {
