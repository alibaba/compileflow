...
final class PostgresDeployStoreContractTest extends DeployStoreContract {
    @Override
    protected DeployStore createEmptyStore() {
        return new PostgresDeployStore(H2TestDatabase.createInMemoryDataSource(), "contract.deploy.");
    }
}
