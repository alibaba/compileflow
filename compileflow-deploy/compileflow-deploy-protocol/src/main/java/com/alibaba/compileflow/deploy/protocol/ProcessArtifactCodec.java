 ...
 * @author yusu
 */
public final class ProcessArtifactCodec {
    private ProcessArtifactCodec() {
    }
    ...
    public static String artifactJson(String namespace, String code, String version, ProcessModelType modelType,
        ...
        ProcessDefinition.Inline definition = ProcessDefinition.inline(modelType, ref.code(), content);
        return artifactJson(new ProcessArtifact(ref, definition, artifactDigest, callBindings));
    }
    ...
    public static String artifactJson(ProcessArtifact artifact) {
        ...
        if (!ProcessArtifactDigest.compute(verified.getDefinition(), targets).equals(verified.getArtifactDigest())) {
        ...
        ProcessArtifactPayload payload = new ProcessArtifactPayload(ref.namespace(), ref.code(), ref.version(),
                verified.getDefinition().modelType(), verified.getDefinition().content(), verified.getArtifactDigest(),
                payloadBindings);
        try {
    ...
    public static ProcessArtifact parse(String json) {
        return ProcessArtifactParser.parse(json);
    }
}
