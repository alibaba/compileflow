 ...
 *
 * <p>This package-private type keeps the mutable Jackson mapper and all Jackson types out of the
 * cross-process protocol surface.
 *
 * @author yusu
 */
final class DeploymentProtocolJson {
