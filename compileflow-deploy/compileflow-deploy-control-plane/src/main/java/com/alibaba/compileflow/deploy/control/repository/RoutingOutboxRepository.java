...
/**
 * Persistence boundary for routing-outbox records awaiting delivery.
 *
 * @author yusu
 */
public interface RoutingOutboxRepository {
    ...
    long insertPendingStandalone(String eventType, String namespace, String code, String alias, String routingKey,
            String payload);

    boolean ensurePendingStandalone(String eventType, String namespace, String code, String alias, String routingKey,
            String payload);
