 ...
 * @author yusu
 */
public interface ProcessVersionRepository extends ProcessArtifactSource {
    ...
    List<ProcessVersionRecord> list(String namespace, String code, String versionPrefix,
