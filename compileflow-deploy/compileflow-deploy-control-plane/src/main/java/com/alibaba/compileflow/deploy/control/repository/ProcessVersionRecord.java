...
public final class ProcessVersionRecord {
    ...
    private ProcessVersionRecord(Builder builder) {
        ...
        modelType = Objects.requireNonNull(builder.modelType, "modelType");
        ...
        ProcessArtifact artifact =
                new ProcessArtifact(ref, modelType, processDefinition, builder.artifactDigest, builder.callBindings);
        ...
        String computedDigest = ProcessArtifactDigest.compute(modelType, processDefinition, callTargets);
    ...
    /**
     * Returns the content-only view consumed by deployment data planes.
     *
     * @return immutable artifact without control-plane audit fields
     */
    public ProcessArtifact toArtifact() {
        return new ProcessArtifact(ref, modelType, processDefinition, artifactDigest, callBindings);
    }

    @Override
    public String toString() {
        return "ProcessVersionRecord{ref=" + ref + ", modelType=" + modelType + ", metadataKeys=" + metadata.keySet()
    ...
    public static final class Builder {
        ...
        public Builder modelType(ProcessModelType modelType) {
