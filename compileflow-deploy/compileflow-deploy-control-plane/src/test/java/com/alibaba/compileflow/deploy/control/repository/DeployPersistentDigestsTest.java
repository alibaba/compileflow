...
class DeployPersistentDigestsTest {
    @Test
    void freezesRolloutRequestFingerprint() {
        assertThat(DeployPersistentDigests.rolloutRequest("CREATE", "commerce", "order", "stable", "v7", "42", "CANARY",
                "2500", "release-bot", "progressive"))
            .isEqualTo("453558e5763e74709d354a6309757e1f60e5892602721ee9cbf2d1cc3e4f3eea");
    }

    @Test
    void freezesRoutingOutboxDeliveryKey() {
        assertThat(DeployPersistentDigests.routingOutbox("ALIAS_STATE_CHANGED", "commerce", "order", "stable",
    ...
    void domainSeparatesEqualFieldSequences() {
        assertThat(DeployPersistentDigests.rolloutRequest("same")).isNotEqualTo(DeployPersistentDigests.routingOutbox(
                "same"));
    }
}
