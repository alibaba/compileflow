 ...
 */
package com.alibaba.compileflow.deploy.control.test;
...
public final class H2TestDatabase {
    private static final String SCHEMA_RESOURCE = "/com/alibaba/compileflow/deploy/control/test/h2-schema.sql";
    ...
    public static DataSource createInMemoryDataSource(String dbName) {
        ...
        dataSource.setURL("jdbc:h2:mem:" + dbName + ";DB_CLOSE_DELAY=-1;MODE=PostgreSQL;LOCK_MODE=1");
