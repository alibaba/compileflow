...
class LocalReadyRoutingStateDeliveryTargetTest {
    ...
    private static String payload() {
        return RoutingStateCodec.aliasStateJson("default", "payment.flow", "production", "v1", null, null, 1L, "test",
                1_800_000_000_000L);
    }

    @Test
    void waitsForLocalReadinessBeforeDeliverySucceeds() {
        LocalRoutingConvergence applier = mock(LocalRoutingConvergence.class);
