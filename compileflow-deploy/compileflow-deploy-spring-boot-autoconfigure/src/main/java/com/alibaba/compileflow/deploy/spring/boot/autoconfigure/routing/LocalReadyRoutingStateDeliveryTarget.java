...
public final class LocalReadyRoutingStateDeliveryTarget implements RoutingStateDeliveryTarget {
    private final LocalRoutingConvergence convergence;
    private final Duration convergenceTimeout;

    public LocalReadyRoutingStateDeliveryTarget(LocalRoutingConvergence convergence, Duration convergenceTimeout) {
    ...
    public void deliver(String routingKey, String payload) {
        ...
        RoutingStateUpdate update = RoutingStateCodec.parse(Objects.requireNonNull(payload, "payload"));
        if (update == null) {
        ...
        convergence.applyAndAwait(DesiredRoutingState.from(update), convergenceTimeout);
    }
}
