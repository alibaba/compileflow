...
public final class EmbeddedAliasRouteConverger implements AliasRouteConverger {
    ...
    public EmbeddedAliasRouteConverger(ProcessAliasStore aliasRepository, LocalRoutingConvergence convergence,
    ...
    public void converge(ProcessRef.Alias alias) {
        ...
        convergence.resolveAndAwait(requested,
                () -> aliasRepository
                    .resolve(requested.namespace(), requested.code(), requested.alias())
                    .map(EmbeddedAliasRouteConverger::toDesiredRoutingState), convergenceTimeout);
    }
}
