...
class DeployPostgresSchemaInitializerTest {
    @Test
    void rejectsNonPostgresDataSourceBeforeSchemaAccess() throws Exception {
        assertThatThrownBy(() -> new DeployPostgresSchemaInitializer(dataSource("MySQL")))
    ...
    void validatesExternallyMigratedSchema() {
        ...
        new DeployPostgresSchemaInitializer(flyway).initialize(false);
    ...
    void migratesThenValidatesEvaluationSchema() {
        ...
        new DeployPostgresSchemaInitializer(flyway).initialize(true);
    ...
    void rejectsPendingMigrationWhenDdlIsExternallyManaged() {
        ...
        assertThatThrownBy(() -> new DeployPostgresSchemaInitializer(flyway).initialize(false))
            .isInstanceOf(IllegalStateException.class)
