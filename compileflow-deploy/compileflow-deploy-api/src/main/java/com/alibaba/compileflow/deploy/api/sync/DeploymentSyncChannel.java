 ...
 */
package com.alibaba.compileflow.deploy.api.sync;

import java.time.Duration;
import java.util.concurrent.Executor;

/**
 * Transport-neutral projection store used by distributed deployment processes.
 *
 ...
 * interruption. The application or dependency-injection container owns the channel lifecycle;
 * callers own and close returned subscriptions.
 *
 * @author yusu
 */
public interface DeploymentSyncChannel {
    /**
     ...
     * @throws Exception when the channel cannot determine the current value
     */
     ...
     * @throws Exception when the channel cannot determine or persist the result
     */
    ...
    /**
     * A channel subscription whose close operation is idempotent.
     */
