...
public final class PublishProcessVersionCommand {
     ...
     */
    public PublishProcessVersionCommand(ProcessRef.Version ref, ProcessDefinition.Inline definition, String actor,
            Map<String, String> metadata) {
        this(ref, definition, null, actor, metadata);
    }
     ...
     */
    public PublishProcessVersionCommand(ProcessRef.Version ref, ProcessDefinition.Inline definition,
            String expectedArtifactDigest, String actor, Map<String, String> metadata) {
