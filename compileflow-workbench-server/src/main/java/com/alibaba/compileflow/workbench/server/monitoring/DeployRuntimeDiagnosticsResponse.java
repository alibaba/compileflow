...
public record DeployRuntimeDiagnosticsResponse(@JsonProperty(required = true) String timestamp,
        ...
        Integer failedAliasCount, List<DeployRuntimeAliasResponse> aliases, Integer inflightCount,
        Integer inflightCapacity, Integer inflightAvailablePermits, Long failureBackoffMs, Integer retainedRuntimeCount,
        List<DeployRuntimeVersionResponse> inflightVersions, List<DeployRuntimeVersionResponse> demandedVersions,
        List<DeployRuntimeVersionResponse> pendingReleaseVersions,
        List<DeployRuntimeBackedOffVersionResponse> backedOffVersions,
        List<DeployRuntimeDeployedProcessResponse> deployedVersions) {
    public DeployRuntimeDiagnosticsResponse {
