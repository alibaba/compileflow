...
/**
 * One page of process summaries.
 *
 * @param data     immutable process page
 * @param total    total matching processes
 * @param page     one-based page number
 * @param pageSize effective page size
 * @author yusu
 */
public record ProcessListResponse(@JsonProperty(required = true) List<ProcessSummaryResponse> data,
