...
public final class DeploymentArtifactProperties {
    ...
    /**
     * Key prefix used when artifacts are stored in a synchronization channel.
     */
    @NotBlank
    private final String keyPrefix;
    /**
     * Deadline for one artifact synchronization-channel operation.
     */
    @NotNull
    private final Duration operationTimeout;

    public DeploymentArtifactProperties(@DefaultValue("DATABASE") Mode mode,
    ...
    public enum Mode {
        ...
        DATABASE,
        /**
         * Publish and resolve artifacts through the deployment sync channel.
         */
        CHANNEL
    }
}
