...
public class CompileFlowEngineMetricsAutoConfiguration {
    @Bean
    @ConditionalOnMissingBean(name = "compileFlowMetricsBinder")
    public MeterBinder compileFlowMetricsBinder(ProcessEngine engine) {
        return new CompileFlowMetricsBinder(engine);
    }
}
