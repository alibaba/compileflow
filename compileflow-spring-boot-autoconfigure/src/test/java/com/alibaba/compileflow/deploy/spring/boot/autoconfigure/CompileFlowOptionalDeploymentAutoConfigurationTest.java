...
class CompileFlowOptionalDeploymentAutoConfigurationTest {
    ...
    void distributedOutboxDoesNotRequireTheRuntimeModule() throws Exception {
        ...
        DeploymentSyncChannel channel = mock(DeploymentSyncChannel.class);
        when(channel.read(anyString(), any(Duration.class))).thenReturn(null);
        ...
        new ApplicationContextRunner()
            ...
            .withBean(RoutingOutboxRepository.class, () -> repository)
            .withBean(DeploymentSyncChannel.class, () -> channel)
            .run(context -> {
                assertThat(context).hasNotFailed();
