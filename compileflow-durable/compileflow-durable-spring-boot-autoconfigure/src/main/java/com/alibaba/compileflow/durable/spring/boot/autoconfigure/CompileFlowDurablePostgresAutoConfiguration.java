...
import com.alibaba.compileflow.durable.spring.boot.autoconfigure.postgres.DurablePostgresSchemaInitializer;
import com.alibaba.compileflow.durable.spring.boot.autoconfigure.properties.CompileFlowDurablePostgresProperties;
 ...
 * @author yusu
 */
@AutoConfiguration(before = CompileFlowDurableAutoConfiguration.class, afterName = {"org.springframework.boot."
...
@EnableConfigurationProperties(CompileFlowDurablePostgresProperties.class)
public class CompileFlowDurablePostgresAutoConfiguration {
    ...
    public DurableStore durableStore(
            ...
            ObjectProvider<DataSource> dataSources, CompileFlowDurablePostgresProperties properties) {
        DataSource dataSource = selectDataSource(durableDataSources, dataSources);
        new DurablePostgresSchemaInitializer(dataSource).initialize(properties.isMigrate());
