 ...
 * @author yusu
 */
public final class DurableDefinitionProperties {
    private static final DataSize MAX_DEFINITION_SIZE = DataSize.ofBytes(DurableStore.MAX_DEFINITION_BYTES);
    /**
    ...
    public DurableDefinitionProperties(@DefaultValue("4MB") DataSize maxSize) {
    ...
    @AssertTrue(message = "compileflow.durable.definition.max-size must be between 1B and "
            + DurableStore.MAX_DEFINITION_BYTES + "B")
