...
/**
 * Audited, revision-fenced request to pause one Run.
 *
 ...
 * @author yusu
 */
public record PauseRunCommand(ProcessRunId runId, long expectedControlRevision, AuditPrincipal actor, String reason,
        String auditContextId) {
    public PauseRunCommand {
