...
class CompileFlowDurableMySqlAutoConfigurationTest {
    @Test
    void dedicatedDurableDataSourceTakesPrecedenceOverApplicationDataSource() {
        ...
        assertThat(CompileFlowDurableMySqlAutoConfiguration.selectDataSource(dedicatedProvider, applicationProvider))
            .isSameAs(dedicated);
    }

    @Test
    void customStoreCompletelyBacksOffMySqlComposition() {
        DurableStore customStore = mock(DurableStore.class);
        new ApplicationContextRunner()
            .withConfiguration(AutoConfigurations.of(CompileFlowDurableMySqlAutoConfiguration.class))
