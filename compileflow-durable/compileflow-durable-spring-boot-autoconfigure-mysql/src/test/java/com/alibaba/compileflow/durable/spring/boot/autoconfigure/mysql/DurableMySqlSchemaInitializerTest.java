...
class DurableMySqlSchemaInitializerTest {
    ...
    void rejectsNonMySqlDataSourceBeforeSchemaAccess() throws Exception {
        ...
        assertThatThrownBy(() -> new DurableMySqlSchemaInitializer(dataSource))
    ...
    void validatesExternallyMigratedSchemaExactlyOnce() {
        ...
        DurableMySqlSchemaInitializer initializer = new DurableMySqlSchemaInitializer(flyway);
    ...
    void migratesThenValidatesEvaluationSchema() {
        ...
        new DurableMySqlSchemaInitializer(flyway).initialize(true);
