...
@Service
public class PaymentCallbackInfoUpdateActivity extends BaseOmActivity {
    @Override
    protected void doExecute(BusinessContext businessContext) {
        // Update payment callback information
        businessContext.put("callbackInfoUpdated", true);
        businessContext.put("callbackTime", System.currentTimeMillis());
    }
}
