...
@Service
public class DeliveryOrderCreateActivity extends BaseOmActivity {
    @Override
    protected void doExecute(BusinessContext businessContext) {
        // Create delivery order
        String orderId = businessContext.getOrderId();
        if (orderId != null) {
            businessContext.put("deliveryOrderId", "DELIVERY-" + orderId);
            businessContext.put("deliveryStatus", "created");
        }
    }
}
