...
final class TestScriptExecutors {
    ...
    static ScriptExecutor of(String name, BiFunction<String, Map<String, Object>, Object> evaluator) {
        return of(name, evaluator, source -> {});
    }

    static ScriptExecutor of(String name, BiFunction<String, Map<String, Object>, Object> evaluator,
            Consumer<String> onCompile) {
        ...
        Consumer<String> compilationObserver = Objects.requireNonNull(onCompile, "onCompile");
        return new ScriptExecutor() {
            ...
            public ScriptProgram compile(ScriptProgramSpec spec) {
                String preparedSource = Objects.requireNonNull(spec, "spec").source();
                compilationObserver.accept(preparedSource);
                return new SourceScript(language, preparedSource);
            }
