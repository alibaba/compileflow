...
@Service
public class PaymentSuccessCallbackActivity extends BaseOmActivity {
    @Override
    protected void doExecute(BusinessContext businessContext) {
        // Handle payment success callback
        businessContext.put("paymentStatus", "success");
        businessContext.put("paymentTime", System.currentTimeMillis());
    }
}
