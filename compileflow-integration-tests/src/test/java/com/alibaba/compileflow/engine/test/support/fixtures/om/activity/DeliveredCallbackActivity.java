...
@Service
public class DeliveredCallbackActivity extends BaseOmActivity {
    @Override
    protected void doExecute(BusinessContext businessContext) {
        // Handle delivery completion callback
        businessContext.put("deliveryStatus", "delivered");
        businessContext.put("deliveredAt", System.currentTimeMillis());
    }
}
