 ...
 * @author yusu
 */
public class StartEventGenerator extends AbstractBpmnNodeGenerator<StartEvent> {

    public StartEventGenerator(AbstractProcessRuntime runtime, StartEvent flowNode) {
