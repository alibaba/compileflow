 ...
 */
package com.alibaba.compileflow.engine.process.builder.generator.factory;
...
import com.alibaba.compileflow.engine.process.builder.generator.constansts.ActionType;
import com.alibaba.compileflow.engine.process.builder.generator.impl.action.AbstractActionGenerator;
import com.alibaba.compileflow.engine.process.builder.generator.impl.action.support.*;
import com.alibaba.compileflow.engine.process.builder.generator.impl.container.ContainerGenerator;
...
public class GeneratorFactory {
    ...
    public AbstractActionGenerator getActionGenerator(IAction action, AbstractProcessRuntime runtime) {
        ...
        if (ActionType.GROOVY.getValue().equals(action.getType())) {
            return new GroovyActionGenerator(runtime, action);
        }
