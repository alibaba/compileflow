...
public class WaitTaskParser extends AbstractTbbpmElementParser<WaitTaskNode> {
    ...
    protected WaitTaskNode doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        waitTaskNode.setId(xmlSource.getString("id"));
        waitTaskNode.setName(xmlSource.getString("name"));
        waitTaskNode.setTag(xmlSource.getString("tag"));
        waitTaskNode.setDescription(xmlSource.getString("description"));
        waitTaskNode.setG(xmlSource.getString("g"));
        return waitTaskNode;
    }
