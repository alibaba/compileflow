 ...
 * @author yusu
 */
public class DecisionWriter extends AbstractTbbpmActionNodeWriter<DecisionNode> {
    ...
    @Override
    protected void enrichNodeAttr(DecisionNode node, XMLStreamWriter xsw) {

    }

    @Override
    protected void enrichNodeElement(DecisionNode element, XMLStreamWriter xsw) throws Exception {
