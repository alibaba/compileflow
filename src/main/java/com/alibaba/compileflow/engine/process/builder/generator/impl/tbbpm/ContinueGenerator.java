 ...
 * @author yusu
 */
public class ContinueGenerator extends AbstractTbbpmNodeGenerator<ContinueNode> {

    public ContinueGenerator(AbstractProcessRuntime runtime,
                             ContinueNode flowNode) {
    ...
    public void generateCode(CodeTargetSupport codeTargetSupport) {
        if (StringUtils.isNotEmpty(flowNode.getExpression())) {
            ...
            codeTargetSupport.addBodyLine("continue;");
