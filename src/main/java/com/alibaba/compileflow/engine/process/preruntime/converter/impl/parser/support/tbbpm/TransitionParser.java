...
public class TransitionParser extends AbstractTbbpmElementParser<Transition> {
    ...
    protected Transition doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        transitionNode.setId(xmlSource.getString("id"));
        transitionNode.setName(xmlSource.getString("name"));
        transitionNode.setExpression(xmlSource.getString("expression"));
        transitionNode.setPriority(xmlSource.getInt("priority"));
        transitionNode.setTo(xmlSource.getString("to"));
        transitionNode.setG(xmlSource.getString("g"));
