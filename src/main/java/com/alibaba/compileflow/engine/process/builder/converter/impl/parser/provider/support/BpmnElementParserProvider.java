...
import com.alibaba.compileflow.engine.process.builder.converter.impl.parser.support.bpmn.*;
...
public class BpmnElementParserProvider extends AbstractFlowElementParserProvider {
    ...
    public void init() {
        ...
        registerParser(new MultiInstanceLoopCharacteristicsParser());
        registerParser(new LoopDataInputRefParser());
        registerParser(new InputDataItemParser());
        registerParser(new OutputDataItemParser());
        registerParser(new LoopDataOutputRefParser());
        registerParser(new DataInputAssociationParser());
        registerParser(new DataOutputAssociationParser());
        registerParser(new DataObjectParser());
        registerParser(new StandardLoopCharacteristicsParser());
        registerParser(new LoopConditionParser());
    }
