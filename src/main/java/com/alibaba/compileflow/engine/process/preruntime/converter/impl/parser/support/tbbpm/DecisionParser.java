...
public class DecisionParser extends AbstractTbbpmElementParser<DecisionNode> {
    ...
    protected DecisionNode doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        decisionNode.setId(xmlSource.getString("id"));
        decisionNode.setName(xmlSource.getString("name"));
        decisionNode.setTag(xmlSource.getString("tag"));
        decisionNode.setDescription(xmlSource.getString("description"));
        decisionNode.setG(xmlSource.getString("g"));
        return decisionNode;
    }
