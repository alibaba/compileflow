...
public class ContinueParser extends AbstractTbbpmElementParser<ContinueNode> {
    ...
    protected ContinueNode doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        continueNode.setId(xmlSource.getString("id"));
        continueNode.setName(xmlSource.getString("name"));
        continueNode.setDescription(xmlSource.getString("description"));
        continueNode.setTag(xmlSource.getString("tag"));
        continueNode.setG(xmlSource.getString("g"));
        continueNode.setExpression(xmlSource.getString("expression"));
        return continueNode;
    }
