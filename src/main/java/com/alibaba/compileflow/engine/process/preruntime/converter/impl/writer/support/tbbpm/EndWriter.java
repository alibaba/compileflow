 ...
 * @author yusu
 */
public class EndWriter extends AbstractTbbpmFlowElementWriter<EndNode> {
    ...
    @Override
    protected void enrichNodeAttr(EndNode node, XMLStreamWriter xsw) {

    }

    @Override
    protected void enrichNodeElement(EndNode element, XMLStreamWriter xsw) throws Exception {
