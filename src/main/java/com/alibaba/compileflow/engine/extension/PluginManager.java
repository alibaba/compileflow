...
import com.alibaba.compileflow.engine.extension.annotation.PluginDependency;
import com.alibaba.compileflow.engine.extension.annotation.PluginDependsOn;
import com.alibaba.compileflow.engine.extension.config.PluginConfig;
import com.alibaba.compileflow.engine.extension.config.PluginDependencyConfig;
import com.alibaba.compileflow.engine.extension.constant.PluginStatus;
import com.alibaba.compileflow.engine.extension.descriptor.PluginDependencyDescriptor;
import com.alibaba.compileflow.engine.extension.exception.PluginException;
import com.alibaba.compileflow.engine.extension.helper.PropertyHelper;
 ...
 * 主要方法说明：
 * <ul>
 *   <li>init()：初始化插件，加载并注册所有插件及其扩展点、扩展实现。</li>
 *   <li>getInstance()：获取单例管理器实例。</li>
 *   <li>插件相关的依赖、状态、注册等管理方法。</li>
 * </ul>
 * <p>
 * 支持SPI、注解、Spring Bean等多种插件注册方式。
 */
public class PluginManager implements Lifecycle {
    ...
    private void registerPlugin(Plugin plugin) {
        ...
        com.alibaba.compileflow.engine.extension.annotation.Plugin
                pluginAnnotation = AnnotationUtils.findAnnotation(plugin.getClass(), com.alibaba.compileflow.engine.extension.annotation.Plugin.class);
