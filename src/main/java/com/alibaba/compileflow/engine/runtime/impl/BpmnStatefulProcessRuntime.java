 ...
 * @author yusu
 */
public class BpmnStatefulProcessRuntime extends AbstractStatefulProcessRuntime<BpmnModel> {

    private BpmnStatefulProcessRuntime(BpmnModel bpmnModel) {
        super(bpmnModel);
    }

    public static BpmnStatefulProcessRuntime of(BpmnModel bpmnModel) {
        return new BpmnStatefulProcessRuntime(bpmnModel);
    }
