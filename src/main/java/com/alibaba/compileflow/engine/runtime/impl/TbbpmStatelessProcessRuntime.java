 ...
 * @author yusu
 */
public class TbbpmStatelessProcessRuntime extends AbstractStatelessProcessRuntime<TbbpmModel> {

    private TbbpmStatelessProcessRuntime(TbbpmModel tbbpmModel) {
        super(tbbpmModel);
    }

    public static TbbpmStatelessProcessRuntime of(TbbpmModel tbbpmModel) {
        return new TbbpmStatelessProcessRuntime(tbbpmModel);
    }
