 ...
 */
package com.alibaba.compileflow.engine.core.infrastructure.bean;
...
public class SpringBeanHolder implements BeanHolder {
    ...
    public <T> T getBean(String name) {
        Validate.notEmpty(name, "Bean name is empty");
        Validate.notNull(context, "Spring application context is not injected");
