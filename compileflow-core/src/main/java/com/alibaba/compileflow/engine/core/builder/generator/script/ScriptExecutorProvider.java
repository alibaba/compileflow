 ...
 */
package com.alibaba.compileflow.engine.core.builder.generator.script;
    ...
    public <T extends ScriptExecutor> T getScriptExecutor(String name) {
        return (T) Optional.ofNullable(scriptExecutorMap.get(name))
                .orElseThrow(() -> new CompileFlowException.ConfigurationException(
                        ...
                        "No script executor found, name is " + name
                ));
    }
    ...
    public void registerScriptExecutor(ScriptExecutor executor) {
        ...
        if (existedExecutor != null && !existedExecutor.getClass().equals(executor.getClass())) {
            throw new CompileFlowException.ConfigurationException(
                    ...
                    "Duplicated executor name[" + executor.getName() + "] found, "
