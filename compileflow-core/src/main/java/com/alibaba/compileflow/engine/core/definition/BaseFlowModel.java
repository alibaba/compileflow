...
/**
 * Abstract base class for {@link FlowModel} implementations.
 * <p>
 * This class provides a skeletal implementation of the {@link FlowModel} interface,
 * managing common attributes such as id, code, name, and variables. Subclasses should
 * provide the specific logic for managing nodes and transitions according to their
 * process standard (e.g., BPMN, TBBPM).
 *
 * @author yusu
 */
public abstract class BaseFlowModel<T extends Node> implements FlowModel<T> {
