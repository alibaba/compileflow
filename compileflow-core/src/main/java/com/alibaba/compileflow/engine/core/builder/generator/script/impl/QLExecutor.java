...
/**
 * QLExpress script executor with optimized configuration for production environments.
 *
 * <p>This implementation uses a singleton ExpressRunner instance with expression caching enabled,
 * following QLExpress official recommendations for high-performance scenarios.</p>
 *
 * <p><b>Thread Safety:</b> QLExpress 3.2.6+ is thread-safe and supports concurrent execution.
 * The singleton pattern with caching provides optimal performance in production environments.</p>
 *
 * @author yusu
 */
    ...
    public Object execute(String expression, IExpressContext context) {
        ...
        try {
            ...
            throw new CompileFlowException.SystemException(
                    ...
                    "QL expression execution failed: " + errorList,
                    e
            );
        }
    }
