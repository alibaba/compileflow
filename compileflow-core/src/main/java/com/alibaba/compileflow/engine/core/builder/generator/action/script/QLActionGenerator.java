...
public class QLActionGenerator extends AbstractScriptActionGenerator {
    ...
    public QLActionGenerator(GeneratorContext context,
                             IAction action) {
    ...
    public void generateCode(CodeTargetSupport codeTargetSupport) {
        ...
        codeTargetSupport.addBodyLine("IExpressContext<String, Object> _ScriptContext = new DefaultContext<>();");
        generateScriptExecuteCode(codeTargetSupport);
    }

    @Override
    public String generateActionMethodName(CodeTargetSupport codeTargetSupport) {
        return "executeQL" + Integer.toUnsignedLong(getExpression().hashCode());
    }
