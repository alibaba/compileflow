...
import com.alibaba.compileflow.engine.bpmn.definition.ReceiveTask;
 ...
 * @author yusu
 */
public class ReceiveTaskGenerator extends AbstractBpmnStatefulNodeGenerator<ReceiveTask> {

    public ReceiveTaskGenerator(GeneratorContext context,
    ...
    public void generateCode(CodeTargetSupport codeTargetSupport) {
        ...
        BpmnModel model = (BpmnModel) context.getFlowModel();
        String event = null;
        if (StringUtils.isNotBlank(flowNode.getMessageRef())) {
            Message message = model.getFlowElement(flowNode.getMessageRef());
