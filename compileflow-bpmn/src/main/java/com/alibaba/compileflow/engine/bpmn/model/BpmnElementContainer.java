...
/**
 * Container that accepts BPMN flow elements during model parsing.
 *
 * @author yusu
 */
public interface BpmnElementContainer extends ElementContainer<AbstractFlowElement, FlowNode> {
}
