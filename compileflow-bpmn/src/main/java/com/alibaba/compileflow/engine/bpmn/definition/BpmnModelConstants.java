...
/**
 * Defines constants used in the BPMN 2.0 model, including namespaces, element names,
 * and attribute names, as specified by the OMG BPMN 2.0 specification.
 * <p>
 * This class also includes constants for related standards like DC (Diagram Commons) and
 * DI (Diagram Interchange), as well as custom extensions for CompileFlow.
 *
 * @author yusu
 */
public final class BpmnModelConstants {
    ...
    /**
     * The XML Schema Instance (XSI) namespace.
     */
    ...
    /**
     * The Zeebe extension namespace (used by Camunda Platform 8).
     */
    ...
    // ========== Diagram Commons (DC) Element Names ==========
    ...
    // ========== Diagram Interchange (DI) Element Names ==========
    ...
    // ========== Diagram Commons (DC) Attribute Names ==========
    ...
    // ========== Diagram Interchange (DI) Attribute Names ==========
    ...
    // ========== BPMN Diagram Interchange (BPMNDI) Attribute Names ==========
    ...
    public static final String BPMN_EXT_ATTRIBUTE_CLASS = "clazz";
    ...
    public static final String BPMN_EXT_ATTRIBUTE_JOB_POLICY = "jobPolicy";
    public static final String BPMN_EXT_ATTRIBUTE_JOB_TIMEOUT = "timeout";
    public static final String BPMN_EXT_ATTRIBUTE_JOB_RETRY = "retry";
    public static final String BPMN_EXT_ATTRIBUTE_JOB_RETRY_ON = "retryOn";
    public static final String BPMN_EXT_ATTRIBUTE_JOB_ON_FAILURE = "onFailure";

    public static final String BPMN_EXT_ATTRIBUTE_ACTION = "action";
    public static final String BPMN_EXT_ATTRIBUTE_IN_ACTION = "inAction";
    public static final String BPMN_EXT_ATTRIBUTE_OUT_ACTION = "outAction";
