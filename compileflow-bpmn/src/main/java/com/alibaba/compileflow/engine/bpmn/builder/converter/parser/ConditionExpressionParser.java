...
import com.alibaba.compileflow.engine.bpmn.definition.Expression;
    ...
    protected Expression doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        if (expressionValue != null) {
            ...
            if (expressionValue.startsWith("${") && expressionValue.endsWith("}")) {
                // Remove the ${} for expression value
                expressionValue = expressionValue.substring(2, expressionValue.length() - 1).trim();
