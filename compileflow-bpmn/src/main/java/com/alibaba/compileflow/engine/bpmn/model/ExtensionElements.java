...
/**
 * Container for BPMN extension elements such as CompileFlow action policies.
 *
 * @author yusu
 */
public class ExtensionElements extends AbstractElement {
    ...
    public void addExtensionElements(ExtensionElement extensionElement) {
