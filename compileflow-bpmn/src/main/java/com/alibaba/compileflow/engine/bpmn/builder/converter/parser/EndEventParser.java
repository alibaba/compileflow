...
import com.alibaba.compileflow.engine.bpmn.definition.EndEvent;
...
public class EndEventParser extends AbstractBpmnElementParser<EndEvent> {
    ...
    @Override
    protected EndEvent doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
    ...
    @Override
    protected void attachChildElement(Element childElement, EndEvent element, ParseContext parseContext) {
