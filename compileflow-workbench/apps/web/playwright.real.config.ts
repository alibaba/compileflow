...
export default defineConfig({
  ...
  webServer: [
    {
      command: `${JAVA_COMMAND} -jar "${JAR}" ` + '--spring.profiles.active=dev --server.port=8080',
    ...
    {
      command:
        'pnpm --filter @compileflow/workbench-web exec vite --host 127.0.0.1 --port 5174 --clearScreen false',
